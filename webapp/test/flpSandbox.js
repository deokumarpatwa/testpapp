		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bulk Approver",
									"targetURL": "#comintappticsmdbulkapprover-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comintappticsmdbulkapprover-display": {
								"semanticObject": "comintappticsmdbulkapprover",
								"action": "display",
								"description": "A Bulk Approver application.",
								"title": "Bulk Approver",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.intapptics.mdbulkapprover",
									"url": sap.ui.require.toUrl("com/intapptics/mdbulkapprover")
								}
							}
						}
					}
